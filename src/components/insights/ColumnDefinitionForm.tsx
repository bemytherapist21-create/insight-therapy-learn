    ...
    return (
        <div className="space-y-6">
            ...
            {structure.sheets.map((sheet) => (
                <div key={sheet.name} className="glass-card rounded-xl overflow-hidden mb-4">
                    <button
                        ...
                        <div className="px-4 pb-4 space-y-3">
                            {sheet.columns.map((col) => {
                                ...
                                return (
                                    <div
                                        key={col.name}
                                        className={`p-3 rounded-lg border transition-colors ${isDefined ? "border-green-500/30 bg-green-500/5" : "border-white/10 bg-white/5"
                                            }`}
                                    >
