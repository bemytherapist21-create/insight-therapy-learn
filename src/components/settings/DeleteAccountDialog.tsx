  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your data deletion request has been logged and will be processed within 30 days as per GDPR compliance.",
      });
      ...
      toast({
        title: "Error",
        description:
          "Failed to process request. Please contact privacy@theeverythingai.com",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
