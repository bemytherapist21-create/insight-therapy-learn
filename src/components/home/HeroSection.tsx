            ...
            <div className="relative container mx-auto px-4 text-center">
                <div className="max-w-4xl mx-auto animate-fade-in">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-4 tracking-tight text-white leading-tight">
                        ...
                        <span className="flex items-center justify-center gap-3 pb-2 leading-normal bg-gradient-to-r from-[#8A2BE2] to-[#FF8C00] bg-clip-text text-transparent">
                            <img src={brainLogo} alt="Brain Logo" className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 object-contain" />
                            The Everything AI
                        </span>
                    </h1>
