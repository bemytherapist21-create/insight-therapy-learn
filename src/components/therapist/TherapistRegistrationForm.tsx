...
const TherapistRegistrationForm = () => {
  const { formData, loading, errors, handleSubmit, updateField } =
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            >
              <SelectTrigger
                className={`bg-white/5 border-white/20 text-white ${errors.licenseType ? "border-red-500" : ""}`}
              >
            ...
            {errors.licenseType && (
              <p className="text-red-400 text-xs mt-1">{errors.licenseType}</p>
            )}
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            >
              <SelectTrigger
                className={`bg-white/5 border-white/20 text-white ${errors.yearsOfExperience ? "border-red-500" : ""}`}
              >
        ...
        <div>
          ...
          <p className="text-white/40 text-xs mt-1 text-right">
            {formData.specializations.length}/500
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-start gap-3">
          ...
          >
            ...
            hold a valid license to practice therapy. *
          </label>
        </div>
        {errors.agreeToTerms && (
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between pt-4">
        ...
        >
          ...
          <span className="text-sm">
            Questions? founder@theeverythingai.com
          </span>
        </a>
        <Button
          type="submit"
