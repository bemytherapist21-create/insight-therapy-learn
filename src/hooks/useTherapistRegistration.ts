...
const therapistRegistrationSchema = z
  .object({
    ...
    specializations: z
      .string()
      .trim()
      .min(5, "Please describe your specializations")
...
export const useTherapistRegistration = () => {
  ...
  const updateField = <K extends keyof TherapistFormData>(
    field: K,
    value: TherapistFormData[K],
  ) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    fetch(API_ENDPOINTS.GOOGLE_SHEETS_THERAPIST, {
      ...
      toast({
        ...
        description:
          "Thank you for registering. We'll review your application and get back to you within 48 hours.",
      });
