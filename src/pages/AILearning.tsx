...
const AILearning = () => {
  const learningCategories = [
    ...
    },
    {
      ...
      description: 'Learn how to implement AI solutions in real business scenarios',
      icon: BookOpen,
      materials: 22,
      hours: 36,
      level: 'Intermediate',
    ...
    },
    {
      ...
      description: 'Deep dive into cutting-edge AI technologies and methodologies',
      icon: Video,
      materials: 18,
      hours: 42,
      level: 'Advanced',
  ...
  const featuredContent = [
    {
      ...
      description: 'Comprehensive guide to understanding neural networks from scratch',
      duration: '3.5 hours',
      rating: 4.9,
      students: 1247,
      icon: Play
    },
    {
      ...
      description: 'Strategic insights on implementing AI in modern enterprises',
      duration: '120 pages',
      rating: 4.8,
      students: 892,
      icon: FileText
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
              ...
              Master artificial intelligence with our comprehensive learning resources.
            </p>
            ...
            <div className="glass-card max-w-lg mx-auto p-6">
              ...
              <p className="text-white/70 mb-4">Access our complete learning library</p>
              <Button 
                size="lg" 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
            {learningCategories.map((category, index) => (
              <Card key={category.title} className="glass-card hover-lift animate-scale-in group" 
                    style={{ animationDelay: `${index * 0.1}s` }}>
                <CardHeader>
                  <div className={`w-16 h-16 mx-auto rounded-2xl bg-gradient-to-r ${category.gradient} p-4 mb-4 group-hover:shadow-glow transition-all duration-300`}>
                    <category.icon className="w-8 h-8 text-white" />
                  </div>
                  <div className="flex justify-center mb-2">
                    <Badge className={`${getLevelColor(category.level)} text-white`}>
                      {category.level}
                    </Badge>
                  </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-lg font-bold text-white">{category.materials}</div>
                      <div className="text-xs text-white/60">Materials</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-white">{category.hours}h</div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {featuredContent.map((content, index) => (
                <Card key={content.title} className="glass-card hover-lift animate-scale-in" 
                      style={{ animationDelay: `${index * 0.1}s` }}>
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button 
                      className="w-full bg-gradient-to-r from-purple-500 to-blue-500 hover:shadow-glow transition-all duration-300"
                    >
            ...
            <Card className="glass-card max-w-4xl mx-auto animate-fade-in">
              <CardContent className="p-12">
                ...
                <p className="text-white/70 mb-8 max-w-2xl mx-auto">
                  ...
                  including videos, documents, worksheets, and interactive content 
                  directly from our Google Drive repository.
                </p>
