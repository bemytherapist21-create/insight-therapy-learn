          ...
          <ScrollArea className="h-[70vh] pr-4">
            <div className="space-y-6 text-gray-200">
              <section>
                ...
                <p>
                  Welcome to The Everything AI ("we," "our," or "us"). We are
              ...
              <section>
                ...
                <p className="mb-2">
                  ...
                  when you participate in activities on the website, or
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    Health Information: Voice data, emotion analysis data, and
                    therapy session transcripts (only with your explicit
                    consent).
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    To facilitate voice therapy sessions and emotion analysis.
                  </li>
                  <li>
                    To improve our AI models (only with anonymized, aggregated
                    data).
                  </li>
              ...
              <section>
                ...
                <p>
                  ...
                  personal information we process. All sensitive data, including
                  therapy transcripts and health information, is encrypted at
                  rest and in transit using industry-standard protocols (AES-256
                  and TLS 1.3).
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  email us at founder@theeverythingai.com.
                </p>
              </section>
            </div>
          </ScrollArea>
