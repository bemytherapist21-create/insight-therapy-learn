  ...
  const benefits = [
    {
      ...
      description:
        "Connect with thousands of users seeking professional mental health support",
    ...
    },
    {
      ...
      description:
        "Set your own availability and manage appointments seamlessly",
    ...
    },
    {
      ...
      description:
        "Help people access quality mental health care when they need it most",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
              Make a difference in people's lives by providing professional
              mental health support on our platform
            </p>
          </motion.div>
          ...
          >
            {benefits.map((benefit, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${benefit.gradient} rounded-2xl flex items-center justify-center`}
                >
