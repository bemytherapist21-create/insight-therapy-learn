            ...
            <div className="space-y-6 text-gray-200">
              <section>
                ...
                <p>
                  ...
                  an entity ("you") and The Everything AI ("we," "us," or
                  "our"), concerning your access to and use of our website and
                  services.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-red-500/20 border border-red-500/50 p-4 rounded-lg">
                  <p className="text-white font-medium">
                    IMPORTANT: The AI Therapy service is NOT a replacement for
                    professional medical advice, diagnosis, or treatment. It is
                    an educational and supportive tool powered by artificial
                    intelligence.
                  </p>
                  <p className="mt-2 text-white">
                    If you are experiencing a medical emergency or having
                    suicidal thoughts, please call your local emergency services
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>
                    Using the Site to mislead, defraud, or solicit information
                    from other users.
                  </li>
                  <li>
                  ...
                  <li>
                    Attempting to bypass any measures of the Site designed to
              ...
              <section>
                ...
                <p>
                  ...
                  contact us at founder@theeverythingai.com.
                </p>
              </section>
            </div>
          </ScrollArea>
