            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        <h1 className="text-4xl font-bold text-white mb-4">Strategic Market Research</h1>
                        <div className="glass-card p-4 inline-block">
                            <p className="text-white/80 text-lg">Analyzing: <span className="text-purple-400 font-semibold">{query}</span></p>
                        </div>
                    </div>
                    ...
                    {loading && (
                        <Card className="glass-card border-purple-500/30">
                            <CardContent className="p-12 text-center">
                                ...
                                <p className="text-white/60">Consulting AI-powered research sources</p>
                                <p className="text-white/40 text-sm mt-2">Usually takes 10-15 seconds</p>
                            </CardContent>
                        </Card>
                    )}
                                    ...
                                    <div className="prose prose-invert prose-headings:text-white prose-p:text-white/90 prose-p:leading-relaxed prose-p:mb-8 prose-li:text-white/90 prose-li:mb-4 prose-ul:mb-8 prose-ol:mb-8 prose-strong:text-white prose-strong:font-bold prose-a:text-blue-400 prose-table:text-white/90 max-w-none">
                                        <ReactMarkdown
                                            ...
                                            components={{
                                                ...
                                                th: ({ node, ...props }) => (
                                                    <th className="px-4 py-3 text-left border border-white/20 font-semibold" {...props} />
                                                ),
                                                td: ({ node, ...props }) => (
                    ...
                    {!loading && !result && query && (
                        <Card className="glass-card border-red-500/30">
                            <CardContent className="p-8 text-center">
                                <h3 className="text-xl font-bold text-red-400 mb-2">Failed to Generate Insight</h3>
                                <p className="text-white/60 mb-6">Unable to fetch research data. Please try again.</p>
