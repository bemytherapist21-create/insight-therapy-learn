  ...
  const therapyOptions = [
    {
      ...
      icon: Bot,
      description:
        "Instant support with our advanced AI counselor. Available 24/7 with personalized responses.",
      features: [
        "24/7 Availability",
        "Instant Responses",
        "Privacy Guaranteed",
    ...
    },
    {
      ...
      icon: Mic,
      description:
        "Experience therapy through natural voice conversation with our AI voice technology.",
      features: [
        "Natural Voice",
    ...
    },
    {
      ...
      icon: User,
      description:
        "Connect with licensed professional therapists for comprehensive mental health support.",
      features: [
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
              Protected by Project Guardian safety framework with real-time risk
              assessment
            </p>
            ...
            <div className="glass-card max-w-2xl mx-auto p-6 mb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="text-center text-sm text-white/60">
                  ...
                  {therapistStats.totalSessions.toLocaleString()}
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {therapyOptions.map((option, index) => (
                ...
                >
                  <Card
                    className="glass-card hover-lift group h-full cursor-pointer"
                    onClick={option.onClick}
                  >
                    <CardHeader className="text-center">
                      <div
                        className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-r ${option.gradient} p-5 mb-4 group-hover:shadow-glow transition-all duration-300`}
                      >
          ...
          >
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">
                Project Guardian Protected
              </h3>
              <p className="text-white/70">
                Multi-layered safety framework with crisis detection
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-white/70">
                Based on evidence-based therapy practices
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-white/70">
                Continuous well-being coefficient tracking
              </p>
            </div>
          </motion.div>
        </div>
